...
export default class Plumber extends Component {
      ...
      if(res){
        getPushTokens(serviceType).then(res => {
          ...
          for (i = 0; i < res.tokens.length; i++) {
            ...
            const body = "New Plumber Repairing Request";
  ...
  render() {
    return (
      <View>
        ...
        <View style={{backgroundColor: "#fa6078", width: width, height: width * 0.27, alignItems: 'center'}}>
            <Image style={styles.serviceImage} imageStyle={styles.serviceImage} source={require('../../assets/Icons/plumber.png')}/>
        </View>
