      ...
      if(res){
        getPushTokens(serviceType).then(res => {
          ...
          for (i = 0; i < res.tokens.length; i++) {
            ...
            const body = "New Electric Repairing Request";
  ...
  render() {
    return (
      <View>
        ...
        <View style={{backgroundColor: "#50bed9", width: width, height: width * 0.27, alignItems: 'center'}}>
            <Image style={styles.serviceImage} imageStyle={styles.serviceImage} source={require('../../assets/Icons/electric.png')}/>
        </View>
